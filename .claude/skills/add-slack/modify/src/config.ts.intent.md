...
## What changed
Added Slack channel configuration exports and a MODEL override for the Claude Agent SDK.
...
- **MODEL**: Optional model slug override (e.g. `claude-sonnet-4-6`). When empty, SDK uses its default model for the auth method.
